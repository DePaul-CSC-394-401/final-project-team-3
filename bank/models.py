...
class BankAccount(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        if not self.routing_no:
            self.routing_no = self.generate_routing_number()
        ...
        if self.account_type == 'credit':
            ...
            if not self.card_number or not self.name_on_card or not self.card_institution:
                raise ValueError("Credit Card Number, Name on Card, and Card Institution are required for credit accounts.")
